...
public interface IMetaDataProviderResolver
{
    ...
    IEnumerable<IMetaDataProviderService> GetAllProviders();
    ...
    IMetaDataProviderService GetProviderByName(string name);

    /// <summary>
    ///     Get all metadata provider settings.
    /// </summary>
    /// <returns>An enumerable collection of all metadata provider settings.</returns>
    IEnumerable<MetaDataProviderSettings> GetAllProviderSettings();
    ...
    MetaDataProviderSettings GetProviderSettingsByName(string name);
}